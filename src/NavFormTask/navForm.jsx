...
import ReuseableTableComponent from "../table/table"
...
return(
     <>
                ...
                <div style={{width:"20%", height:"500px"}}>
                    ...
                    <button style={{width:"100px",border:"none",margin:"10px"}} onClick={formComponentFun}>Add Item</button>
                </div>
                  <div style={{width:"80%", height:"500px", overflow:"auto"}}>
                    {
                       showTable && <ReuseableTableComponent/> 
                    }
                    </div>
                </div>
